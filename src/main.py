...
if __name__ == "__main__":
    ...
    sd_card_path = args.sd_card_name
    ...
    end_dir, end_iamge, end_date = transfer_photos(start_dir, start_image, external_hd_path, include_day=include_day, end_on=end_on)

    sd_card_name = os.path.basename(sd_card_path)
    write_to_migration_table(sd_card_name, start_dir, start_image, start_date, end_date, end_dir, end_date, TABLE_PATH, migration_name=migration_name)